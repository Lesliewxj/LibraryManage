    ...
    <div class="pageSidebar">
        <ul class="layui-nav layui-nav-tree">
            ...
            <li class="layui-nav-item">
                <a href="JavaScript:;" target="mainFrame">个人信息管理</a>
                <dl class="layui-nav-child">
                    <dd><a href="LookPersonInfo?ID=<%=session.getAttribute("id")%>&&fl=reader" target="mainFrame">个人信息</a></dd>
                </dl>
                <dl class="layui-nav-child">
            ...
            <li class="layui-nav-item ">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="BookInfo?fl=reader" target="mainFrame">查看图书信息</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
                <a href="JavaScript:;">借阅信息</a>
                <dl class="layui-nav-child">
                    <dd><a href="RentInfo?id=<%=session.getAttribute("id")%>" target="mainFrame">查看借阅图书信息</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
